...
extension IdentityStepExtension on _AddCustomerBottomSheetState {
  // ===========================================================================
  // STEP 1 — Identity
  // ===========================================================================
  Widget _buildIdentityStep(Map<String, String> errors) {
    ...
    return Column(
      ...
      children: [
        _twoCol(
          _dropdown(
            label: 'add_customer.grouping'.tr,
          ...
          _dropdown(
            label: 'add_customer.title_field'.tr,
        ...
        if (_showMoreIdentity) ...[
          ...
          _twoCol(
            _text(
              _name2Ctrl,
              'add_customer.name2_hint'.tr,
              label: 'add_customer.name2'.tr,
              icon: Icons.badge_outlined,
              compact: true,
            ...
            _text(
              _coNameCtrl,
              'add_customer.co_name_hint'.tr,
              label: 'add_customer.co_name'.tr,
            ...
            Column(
              ...
              children: [
                _text(
                  ...
                  label: 'add_customer.search_term1'.tr,
            ...
            Column(
              ...
              children: [
                _text(
                  ...
                  label: 'add_customer.search_term2'.tr,
