...
part 'add_customer/shared_components.dart';
part 'add_customer/mobile_layout.dart';
part 'add_customer/tablet_layout.dart';
part 'add_customer/identity_step.dart';
part 'add_customer/address_step.dart';
part 'add_customer/contact_step.dart';
part 'add_customer/sales_terms_step.dart';
part 'add_customer/documents_step.dart';
part 'add_customer/review_step.dart';
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: widget.isFullScreen
                          ...
                          : BorderRadius.vertical(
                              top: Radius.circular(widget.isTablet ? 24 : context.rr(24)),
                            ),
                    ),
                    padding: EdgeInsets.fromLTRB(
                      widget.isTablet ? 36 : context.rw(16),
                      ...
                      widget.isTablet
                          ? 24
                          : context.deviceInsets.sheetBottomInset(extra: context.rh(8)),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                              ...
                              child: state.isBusy
                                  ...
                                  : _isTabletLayout
                                      ...
                                      : KeyedSubtree(
                                          ...
                                          child: _buildStepBody(state.currentStep, state.errors),
                                        ),
                            ),
                          ),
                        ),
