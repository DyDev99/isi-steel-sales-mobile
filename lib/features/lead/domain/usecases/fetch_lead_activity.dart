...
class FetchLeadActivity extends LeadUseCase<List<ActivityLogItem>, LeadIdParams> {
  const FetchLeadActivity(this._repository);
  final LeadRepository _repository;

  @override
  Future<List<ActivityLogItem>> call(LeadIdParams params) => _repository.fetchActivity(params.leadId);
}
