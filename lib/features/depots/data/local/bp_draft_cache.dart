...
/// ## Why no TTL
///
/// [DepotReferenceCache] expires because a stale catalogue is wrong.
...
class BpDraftCache {
  ...
  Future<BpDepotDraft?> read() async {
    ...
    try {
      ...
      return BpDepotDraft.fromDraftJson(decoded.cast<String, dynamic>());
    } on Object {
      await clear();
      return null;
    }
