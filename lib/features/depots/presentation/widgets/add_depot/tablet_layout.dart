...
extension TabletLayoutExtension on _AddDepotBottomSheetState {
  // ===========================================================================
  // Tablet Header & Progress
  // ===========================================================================
  Widget _buildTabletFormHeader(AddDepotState state) {
    final stageTitles = [
      (
        title:
            '${'add_depot.steps.identity'.tr} & ${'add_depot.steps.address'.tr}',
        subtitle: 'add_depot.subtitle'.tr,
      ),
      (
        title:
            '${'add_depot.steps.contact'.tr} & ${'add_depot.steps.sales_terms'.tr}',
        subtitle:
            'Configure contact details, commercial pricing & tax classification',
      ),
      (
        title: 'add_depot.steps.documents'.tr,
        subtitle: 'Upload required verification photos and internal remarks',
      ),
      (
        title: '${'add_depot.review'.tr} & ${'add_depot.send_to_hq'.tr}',
        subtitle:
            'Verify all registered depot information before final submission',
      ),
    ];
  ...
  Widget _buildTabletStepProgress(AddDepotState state) {
    final stages = [
      '1. General & Location',
      '2. Contact & Terms',
      '3. Documents & Notes',
  ...
  // ===========================================================================
  Widget _buildTabletStageBody(AddDepotState state) {
    return switch (_tabletStage) {
          ...
          children: [
            Expanded(
              child: _buildSectionCard(
                title: 'add_depot.steps.identity'.tr,
                subtitle: 'Who is the depot (BP header & names)',
            ...
            Expanded(
              child: _buildSectionCard(
                title: 'add_depot.steps.address'.tr,
      ...
      1 => Row(
          ...
          children: [
            Expanded(
              child: _buildSectionCard(
                title: 'add_depot.steps.contact'.tr,
            ...
            Expanded(
              child: _buildSectionCard(
                title: 'add_depot.steps.sales_terms'.tr,
  ...
  void _handleTabletNext(AddDepotState state) {
    if (_tabletStage == 0) {
  ...
  Widget _buildTabletNavigationButtons(AddDepotState state) {
    final isFirst = _tabletStage == 0;
    final isLast = _tabletStage == 3;
    final isUploadingDoc =
        _tabletStage == 2 && state.draft.attachments.any((a) => a.isUploading);
    final needsCredit =
      ...
      children: [
        ...
        Expanded(
          ...
          child: ElevatedButton.icon(
            ...
            onPressed: (state.isBusy || isUploadingDoc)
                ? null
            ...
            label: Text(
              isUploadingDoc
                  ? 'add_depot.photo_uploading'.tr
                  : (isLast
                      ? (needsCredit
                          ? 'add_depot.send_for_credit_approval'.tr
                          : 'add_depot.send_to_hq'.tr)
                      : (_tabletStage == 2
                          ? 'Preview & Review'
                          : 'add_depot.next_step'.tr)),
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(
                color: Colors.white,
  ...
  Widget _buildTabletPreviewScreen(BpDepotDraft draft) {
    final colors = context.appColors;
    final scheme = Theme.of(context).colorScheme;
    final needsCredit =
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      draft.nameEn.isNotEmpty ? draft.nameEn : 'New Depot',
                      style: TextStyle(
                ...
                children: [
                  ...
                  previewCard(
                    ...
                    children: [
                      ...
                      previewItem('Depot Group', draft.depotGroup ?? '—'),
                      ...
                      if (draft.creditLimit != null)
                        previewItem('Credit Limit',
                            '\$${draft.creditLimit!.toStringAsFixed(0)}'),
                      previewItem(
                          'Tax Class',
                          draft.taxClass == '1'
                              ? '1 - Taxable'
