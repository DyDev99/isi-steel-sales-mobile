...
extension SharedComponentsExtension on _AddDepotBottomSheetState {
  // ===========================================================================
  ...
  Widget _twoCol(Widget left, Widget right,
      {int flexLeft = 1, int flexRight = 1}) {
    return Row(
                ...
                if (label != null || icon != null)
                  Row(
                    children: [
                      ...
                      if (label != null)
                        Expanded(
                          child: _cardLabel(label,
                              required: required, fontSize: 12),
                        ),
                    ],
                  ),
  ...
  Widget _cardLabel(String label,
          {bool required = false, double fontSize = 13}) =>
      RichText(
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
        text: TextSpan(
  ...
  Widget _text(
    ...
    return Column(
      ...
      children: [
        field,
        if (error != null) _errorText('add_depot.$error'.tr),
      ],
    );
  }
    ...
    final field = PhoneFormField(
      ...
      validator: PhoneValidator.compose([
        PhoneValidator.required(context,
            errorText: 'add_depot.error.required'.tr),
        PhoneValidator.validMobile(context,
            errorText: 'add_depot.error.invalid_phone'.tr),
      ]),
      decoration: _decoration(hint, error: error),
    );
  ...
  Widget _dropdown({
    ...
    if (hasValue && !resolved.any((o) => o.code == value)) {
      resolved.insert(
        0,
        SapOption(
            value, 'add_depot.unrecognised_code'.trParams({'code': value})),
      );
    }
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Text(
                expanded
                    ? 'add_depot.show_less'.tr
                    : (labelCollapsed ?? 'add_depot.more_details'.tr),
                style: TextStyle(
                  color: Theme.of(context).colorScheme.secondary,
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: hasError
              ...
              : (completed ? const Color(0xFFF0FDF4) : Colors.white),
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: hasError
                ? Theme.of(context).colorScheme.error
                : (completed
                    ...
                    : const Color(0xFFE2E8F0)),
            width: (completed || hasError) ? 1.5 : 1.1,
          ),
          boxShadow: [
            BoxShadow(
              color: Colors.black.withValues(alpha: 0.02),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: _fontSize(11),
                      fontWeight: (isUploading || hasError)
                          ? FontWeight.w600
                          : FontWeight.normal,
                    ),
                  ),
