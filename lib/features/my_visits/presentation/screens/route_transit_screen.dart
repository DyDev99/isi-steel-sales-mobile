...
/// TEMP TESTING FLAG — forces "I've Arrived" to be unlocked regardless of the
/// real geofence status, so the check-in flow can be tested without
/// physically standing inside a shop's geofence radius.
///
/// TODO: flip this back to `false` (and wire the real
/// `state.insideGeofence` value through) before shipping.
        ...
        builder: (context, state) {
          ...
          return Column(
            children: [
              _TransitHeader(
                stop: stop,
                insideGeofence: kDebugForceInsideGeofence,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 5),
                      Text('~$etaMinutes ${'my_visits.flow.minutes_short'.tr}',
    ...
    return AnimatedBuilder(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text('my_visits.flow.ive_arrived'.tr, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800)),
