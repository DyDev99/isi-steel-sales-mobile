  ...
  Widget _build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('my_visits.flow.checkin_title'.tr,
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      Text('my_visits.flow.proof_photo'.tr,
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('my_visits.flow.checkin_continue'.tr,
