          ...
          children: [
            ...
            InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color:
                      _isCustomActive ? const Color(0xFF0F2C7F) : Colors.white,
                  borderRadius: BorderRadius.circular(24),
                  border: Border.all(
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: _isCustomActive
                            ...
                            : const Color(0xFF334155),
                        fontWeight:
                            _isCustomActive ? FontWeight.bold : FontWeight.w600,
                        fontSize: 13,
                      ),
                    ),
                  ],
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixStyle: const TextStyle(
                    fontWeight: FontWeight.bold, color: Color(0xFF0F2C7F)),
                filled: true,
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(8),
                  borderSide:
                      const BorderSide(color: Color(0xFF0F2C7F), width: 1.5),
                ),
              ),
            ),
          ),
