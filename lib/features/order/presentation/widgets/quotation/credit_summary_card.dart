...
class CreditSummaryCard extends StatelessWidget {
  const CreditSummaryCard(
      {super.key, required this.creditLimit, required this.summary});
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('orders.shop.credit_remaining'.tr,
                        style:
              ...
              if (summary.notes.isNotEmpty)
                Container(
                  ...
                  child: Text('${summary.notes.length} CN/DN',
          ...
          if (summary.notes.isNotEmpty) ...[
            ...
            Text('orders.shop.outstanding'.tr,
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isCredit ? Vibe.success : Vibe.danger)
