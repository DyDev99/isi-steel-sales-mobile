...
class CartSummaryCard extends StatelessWidget {
  const CartSummaryCard({super.key, required this.itemCount, required this.subtotal});
  ...
  Widget build(BuildContext context) {
    return GlassCard(
      ...
      child: Row(
        children: [
          const Icon(Icons.shopping_cart_outlined, color: Vibe.violet, size: 18),
          ...
          Text(
            ...
            style: const TextStyle(color: Vibe.violet, fontSize: 15, fontWeight: FontWeight.w800),
          ),
        ],
      ),
    );
