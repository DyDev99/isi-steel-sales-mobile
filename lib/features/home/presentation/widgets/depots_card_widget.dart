...
/// Depots summary card. Headline = total depots; the distribution
...
class DepotCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DashboardKpiCard(
      title: title ?? 'home.quick_access.depots'.tr,
      icon: Icons.groups_rounded,
      iconColor: colors.success,
      headline: '$totalDepots',
      headlineCaption: 'home.quick_access.total_depots'.tr,
