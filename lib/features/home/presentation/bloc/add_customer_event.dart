...
class UpdateShopDetails extends AddCustomerEvent {
  ...
  UpdateShopDetails({required this.shopName, required this.shopType, required this.ownerName});
}
...
class UpdateContactDetails extends AddCustomerEvent {
  ...
  final String role;
  final String phone;
  UpdateContactDetails({required this.name, required this.role, required this.phone});
}
...
class UpdateLocationAndPapers extends AddCustomerEvent {
  ...
  UpdateLocationAndPapers({required this.gpsLocation, required this.businessLicencePath, required this.taxPaperPath});
}
