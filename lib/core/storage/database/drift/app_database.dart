...
import 'package:isi_steel_sales_mobile/core/storage/database/drift/connection/encrypted_database.dart';
import 'package:isi_steel_sales_mobile/core/storage/database/drift/daos/app_metadata_dao.dart';
...
import 'package:isi_steel_sales_mobile/core/storage/database/drift/tables/customer_related_tables.dart';
import 'package:isi_steel_sales_mobile/core/storage/database/drift/tables/customers_table.dart';
...
@DriftDatabase(
  ...
  daos: [AppMetadataDao, CustomerDao, CatalogDao, CartDao],
)
