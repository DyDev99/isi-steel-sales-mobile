...
> Scope note: this work is outside the current `docs/blueprint/migration-plan.md` sprint sequence (T1.x infra);
...
warnings/infos in untouched files). Architecture and extension guide: `docs/skills/localization.md`.
