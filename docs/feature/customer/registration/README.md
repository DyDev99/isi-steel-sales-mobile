...
|---|---|
| [`docs/feature/customer/registration/api.md`](api.md) | The endpoints, with verified request and response shapes |
| [`docs/feature/customer/registration/sap-helpers.md`](sap-helpers.md) | All ten catalogues as the live API actually returns them |
