...
(`docs/blueprint/sync-architecture.md`); repeated here only for what this flow depends on:
...
Related: [`docs/blueprint/system-architecture.md`](../../../blueprint/system-architecture.md) ·
