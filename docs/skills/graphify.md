...
The Clean Architecture layering in `docs/blueprint/system-architecture.md` §2 shows up as these
...
the encrypted-database work in `docs/blueprint/migration-plan.md` T1.3 lands.
