...
> **Gate:** `docs/FEATURE_UI_STANDARD.md`. Every task below cites the rule it
...
of Done (`FEATURE_UI_STANDARD.md` §15) at 390 / 600 / 834 / 1032 / 1280 / 1440pt,
...
Then tick `FEATURE_UI_STANDARD.md` §14 in the PR.
