...
traceId, timestamp}`. See the [mobile integration guide](mobile-integration-guide.md#3-three-response-shapes--read-this-first)
...
[`POST /mobile/visits/push`](mobile-integration-guide.md#7-routes-and-visits):
...
- [mobile-integration-guide.md](mobile-integration-guide.md) — start here: envelopes, auth, errors, the endpoint map
- [features/Material SAP API Integration – Backend .NET README.md](features/Material%20SAP%20API%20Integration%20%E2%80%93%20Backend%20.NET%20README.md) — the SAP side
